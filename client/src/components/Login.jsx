    ...
    return (
        <div className='fixed top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
          <motion.form onSubmit={onSubmitHandler}
            ...
            { state !== 'Login' && <div className='border-t px-6 py-2 flex items-center gap-2 rounded-full mt-5'>
            ...
            <div className='border-t px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
