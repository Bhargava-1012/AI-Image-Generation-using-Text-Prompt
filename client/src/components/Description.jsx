  ...
  return (
    ...
    className='flex flex-col items-center justify-center my-24 p-6 md:px-28'>
      ...
      <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
        ...
        <div>
            <h2 className='text-3xl font-medium max-w-lg mb-4'>Introducing theAI-Powered Text to Image Generator</h2>
            ...
            <p className='text-gray-600'>Simply type in text prompt, and our cutting-edge AI will generate high-quality images in seconds. From product visuals to character designs and portraits, even concepts that don't yet exist can be visualized effortlessly. Powered by advanced AI technology, the creative possibilities are limitless!</p>
        </div>
      </div>
    </motion.div>
  )
